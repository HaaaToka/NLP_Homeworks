...
def randsentence(cfg_rules,output_file_path=None):
    """
    ...
    coin = randint(1,1)
    if coin:
        print("--> RULE BASED SENTENCE GENERATED")
        sentence.append("S")
        flag=1
        while flag:
            flag=0
...
def CYKParser(sentence,rules,triangle):
    """
...
def main():
    ...
    # print(magic_dict,end="\n\n")
    print(cfg_dict)

    generated_sentence = randsentence(cfg_dict)
    print("GGG ==>> ",generated_sentence)
    #generated_sentence = "i want sdfa"
    # generated_sentence = "this delicious sandwich on you ate me"

    print(CYKParser(generated_sentence,cfg_dict,magic_dict))
